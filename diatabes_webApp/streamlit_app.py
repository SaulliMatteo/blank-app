...
diabetes_model = pickle.load(open('diabetes_trained.sav', 'rb'))
heart_model = pickle.load(open('heart_deseas_trained.sav', 'rb'))
parkinson_model = pickle.load(open('parkinson_trained.sav', 'rb'))
